...
<div class="row mt-3" style="margin-bottom: 0px">
    <div class="col-12 d-flex justify-content-center">
      {% include figure.html path="assets/img/2025-04-28-linrec/GA100-arch.png" class="img-fluid" max-width="600px" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3" style="margin-bottom: 0px">
    <div class="col-12 d-flex justify-content-center">
      {% include figure.html path="assets/img/2025-04-28-linrec/GA100-sm.png" class="img-fluid" max-height="350px" max-width="265" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3" style="margin-bottom: 0px">
    <div class="col-12 d-flex justify-content-center">
      {% include figure.html path="assets/img/2025-04-28-linrec/bench.png" class="img-fluid" max-width="600px" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3" style="margin-bottom: 0px">
    <div class="col-12 d-flex justify-content-center">
      {% include figure.html path="assets/img/2025-04-28-linrec/hw_scaling.png" class="img-fluid" max-width="600px" %}
    </div>
</div>
<div class="caption">
